...
import center from '@/views/center'
    import nianlingtongji from '@/views/modules/nianlingtongji/list'
    ...
    import shuliangfenxi from '@/views/modules/shuliangfenxi/list'
